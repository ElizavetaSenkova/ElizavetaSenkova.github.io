$(function() {
	...
	$('#assortment__slider').on('afterChange', function(event, slick, currentSlide, nextSlide){ 
		if($("#first_item").parents('.slick-slide').hasClass("slick-active")){
			$(".assortment").css({'background-image': 'url(safeline/img/assortment/pro/back.jpg)'});
		}

		if($("#second_item").parents('.slick-slide').hasClass("slick-active")){
				$(".assortment").css({'background-image': 'url(safeline/img/assortment/auto/back.jpg)'});
		}

		if($("#third_item").parents('.slick-slide').hasClass("slick-active")){
				$(".assortment").css({'background-image': 'url(safeline/img/assortment/master/back.jpg)'});  
		}

		if($("#fourth_item").parents('.slick-slide').hasClass("slick-active")){
			$(".assortment").css({'background-image': 'url(safeline/img/assortment/addition/back.jpg)'});  
		}
